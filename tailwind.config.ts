  ...
  theme: {
    extend: {
      colors: {
        ...
        // Age group colors (Børnegaveguiden)
        age: {
          "0-2": "#FFD1DC",   // Pink - Baby & småbørn
          "3-5": "#BAFFC9",   // Grøn - Børnehavebørn
          "6-9": "#BAE1FF",   // Blå - Indskoling
          "10-12": "#E8D5FF", // Lilla - Mellemtrin
          "13-15": "#FFE4B5", // Guld - Teenager/Konfirmation
        },
